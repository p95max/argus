...
from alerts.telegram.status_command import (
    handle_ads_status_command,
    handle_mailboxes_status_command,
)
...
async def log_telegram_error(update, context):
    logger.error("Telegram bot error. update=%s", update, exc_info=context.error)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        message = f"Telegram bot polling started. Allowed chats: {allowed_chats}. Allowed users: {allowed_users}."
